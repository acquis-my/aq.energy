...
const Step2 = ({ data, next, prev }: any) => {
  return (
    <Formik
      initialValues={data}
      ...
      {({ values, errors, touched, setFieldTouched, setFieldValue }) => (
        <Form>
          <div className="grid grid-cols-6 gap-6 ">
            ...
            <div className="w-full flex justify-center sm:justify-end items-end col-span-6 gap-2">
              <button
                type="button"
                onClick={() => prev(values)}
                className="inline-flex items-center rounded-md border border-gray-300 bg-white h-10 px-6 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
                Back
              </button>
              <button
